  ...
  return (
    <div className="bg-[#fbf9f6] text-[#1b1c1a] min-h-screen flex flex-col selection:bg-emerald-100 selection:text-emerald-900">
      ...
      <header className="fixed top-0 left-0 right-0 z-50 px-8 h-20 flex items-center justify-between">
        <div className="w-24" />
        <Link href="/">
          <h1 className="font-serif text-3xl font-bold tracking-tighter text-emerald-950">
            YouVisa <span className="text-sm font-sans tracking-normal bg-emerald-950 text-white px-2 py-0.5 rounded-md align-middle ml-2">Admin</span>
          </h1>
        </Link>
